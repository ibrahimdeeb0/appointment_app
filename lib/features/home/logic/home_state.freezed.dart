...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<DoctorModel?>? doctorsList) doctorsSuccess,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<DoctorModel?>? doctorsList)? doctorsSuccess,
...
class _$DoctorsSuccessImpl implements DoctorsSuccess {
  const _$DoctorsSuccessImpl(final List<DoctorModel?>? doctorsList)
...
abstract class DoctorsSuccess implements HomeState {
  const factory DoctorsSuccess(final List<DoctorModel?>? doctorsList) =
